...
from UVR import ModelData, Ensembler, extract_stems
from separate import SeperateDemucs, SeperateMDX, SeperateMDXC, SeperateVR, save_format


BASE_PATH = os.path.dirname(os.path.abspath("D:/Workspace2/Speech/Test"))
...
class MainWindow:
    ...
    def __init__(self):
        ...
        self.is_secondary_stem_only_var = tk.BooleanVar(value=False)
        self.is_primary_stem_only_var = tk.BooleanVar(value=False)
        self.is_create_model_folder_var = tk.BooleanVar(value=False)
