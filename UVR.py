...
class MainWindow(TkinterDnD.Tk if is_dnd_compatible else tk.Tk):
    ...
    def __init__(self):
        ...
        self.logo_img = img.open_image(
            path=img.banner_path, size=(self.winfo_width(), 9999)
        )
    ...
    def fill_main_frame(self):
        ...
        self.console_Frame.place(
            x=X_CONSOLE_FRAME_1080P,
            y=Y_OFFSET_CONSOLE_FRAME_1080P,
            width=WIDTH_CONSOLE_FRAME_1080P,
            height=HEIGHT_CONSOLE_FRAME_1080P,
            relx=0,
            rely=0,
            relwidth=1,
            relheight=0,
    ...
    def fill_filePaths_Frame(self):
        ...
        self.filePaths_musicFile_Open.place(
            x=MUSICFILE_OPEN_X,
            y=MUSICFILE_OPEN_Y,
            width=MUSICFILE_OPEN_WIDTH,
            height=MUSICFILE_OPEN_HEIGHT,
            relx=1,
            rely=0,
            relwidth=0,
            relheight=0,
        ...
        self.filePaths_saveTo_Open.place(
            x=SAVETO_OPEN_X,
            y=SAVETO_OPEN_Y,
            width=SAVETO_OPEN_WIDTH,
            height=SAVETO_OPEN_HEIGHT,
            relx=1,
            rely=0,
            relwidth=0,
            relheight=0,
    ...
    def fill_options_Frame(self):
        ...
        self.overlap_mdx_Label = self.main_window_LABEL_SET(
            self.options_Frame, OVERLAP_TEXT
        )
    ...
    def menu_settings(self, select_tab_2=False, select_tab_3=False):  # **
        ...
        select_Option = ComboBoxMenu(
            ...
            values=OPTION_LIST,
            width=GEN_SETTINGS_WIDTH + (3 if is_windows else 3),
        )
    ...
    def menu_help(self):  # **
        ...
        application_change_log_Text = tk.Text(
            ...
            bg="black",
            width=72,
            wrap=tk.WORD if is_windows else tk.CHAR,
            borderwidth=0,
        )
    ...
    def pop_up_vr_param(self, vr_model_hash):
        ...
        vr_param_title_title = self.menu_title_LABEL_SET(
            vr_param_Frame, SPECIFY_VR_MODEL_PARAMETERS_TEXT, width=25
        )
